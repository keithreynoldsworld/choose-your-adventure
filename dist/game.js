function* chooseYourAdventure(){
	...
	if(whichDrug === ('Marijuana' || 'Molly' || 'Cocaine')){yield adventure.say('YOU ARE BORING. rock stars do all the drugs they can.','Perhaps you could consider being a high school guidance counselor. THE END');}
	...
	if(whichActivity === ('Save a kitten' || 'Read a true crime novel' || 'Study French')){yield adventure.say('YOU ARE BORING.','perhaps you should consider being a veterinarian, a detective, or a mime. THE END');} 
